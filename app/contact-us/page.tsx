      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Pakistan Office</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">China Office</h4>
                    <p className="text-gray-600 text-sm">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      <a href="tel:+923362143021" className="hover:text-orange-500">
                        +92 336 2143021
                      </a>
                      <br />
                      <a href="tel:+8615622314171" className="hover:text-orange-500">
                        +86 156 2231 4171
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      <a href="mailto:info@meenaaslam.com" className="hover:text-orange-500">
                        info@meenaaslam.com
                      </a>
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="p-3 bg-gray-100 rounded-full hover:bg-orange-500 hover:text-white transition-colors"
                  >
                  ...
                  <a
                    ...
                    className="p-3 bg-gray-100 rounded-full hover:bg-green-500 hover:text-white transition-colors"
                  >
            ...
            {/* Contact Form */}
            <div className="bg-gradient-to-br from-orange-50 to-white rounded-3xl p-8 shadow-xl">
